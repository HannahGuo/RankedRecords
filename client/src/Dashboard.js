...
export default function Dashboard({code}) {    
    ...
    function createPlaylist() {
        ...
        spotifyApi.createPlaylist(`${playlistTitle}`, {
                                  'description': `${playlistDescBeginning}, ranked by ${sortMethod === "release_date" ? "chronology" : sortMethod}. ${filteredStr} Generated by 💿 Ranked Records (https://hannahguo.me/RankedRecords/) on ${today}`, 
                                  'public': true
                                }).then(async (data) => {  
